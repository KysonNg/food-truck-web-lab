...
public class App {
    ...
    public static void main(String[] args) {
        ...
        get("/order", (req, res) -> {
            ...
            if (total > 20.00) {
                html += "<p style='color:green;'><b>Congratulations! You qualify for a free dessert plus a 20% discount!</b></p>";
                double discount = total * 0.10;
                double discountedTotal = total - discount;
                html += "<p>Discount Amount: -" + money(discount) + "</p>";
                html += "<p><b>New Total after Discount:</b> " + money(discountedTotal) + "</p>";
                html += "<p><b>Free Dessert Added to your order!</b></p>";
            }
